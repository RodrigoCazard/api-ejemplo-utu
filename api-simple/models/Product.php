 ...
 * ==================================================================
 * Igual que User, pero aca SI hacen falta SETTERS, porque un producto
 * se puede modificar (cambiarle el precio, el stock...).
 *
 * ?Y por que no hacer las propiedades publicas y listo?
 * Mira el setStock() de mas abajo: adentro del setter podemos poner
 * REGLAS. Asi se vuelve imposible que un producto quede con stock
 * negativo, no importa quien intente modificarlo.
 *
...
class Product
{
     ...
     * El producto sabe si tiene stock; no hace falta preguntarselo
